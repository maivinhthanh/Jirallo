      ...
      >
        <Fade in={open}>
          ...
          <Grid container>
              ...
              <Grid container>
                <Grid item xs={12}>
                  <Avatar alt="Reporter" src={props.issues.repoter.image} /> <h6>{props.issues.repoter.name}</h6>
                </Grid>
              </Grid>
              <hr/>
              <Grid container>
              ...
              <Grid container>
                <Grid item xs={12}>
                  <Avatar alt="Assignee" src={props.issues.assignee.image} /> <h6>{props.issues.assignee.name}</h6>
                </Grid>
              </Grid>
          </div>
        </Fade>
